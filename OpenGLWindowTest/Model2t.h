...
public:
    ...
    Material material;
    TYPE modelType;
    unsigned int VBO, VAO, diffuseMap, specMap, triangles;
    ...
    Model2t(float* vertices, int length, const char* diffusePath, const char* SpecularPath, const char* vShaderPath, const char* fShaderPath, glm::mat4* projection, Camera* camera, Model* lightModel, Material material)
    {
        ...
        createTextureShader(diffusePath, SpecularPath, vShaderPath, fShaderPath);

    }

    void createTextureShader(const char* diffusePath, const char* SpecularPath, const char* vShaderPath, const char* fShaderPath)
    {
        // texture 1
        // ---------
        diffuseMap = loadTexture(diffusePath);
        specMap = loadTexture(SpecularPath);
